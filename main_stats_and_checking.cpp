...
int main(int argc, char** argv) {
    ...
    // box_height = ed.euc_dist(lat_min_to_y,lon_min_to_x,lat_max_to_y,lon_min_to_x, x_scale, y_scale);
    // box_width = ed.euc_dist(lat_min_to_y,lon_max_to_x,lat_min_to_y,lon_min_to_x, x_scale, y_scale);
// 
    // cout<<"box_height_geo: "<<g_dist1<<" "<<"box_width_geo: "<<g_dist2<<endl;
// 
    // cout<<"box_height: "<<box_height<<" "<<"box_width: "<<box_width<<endl;
